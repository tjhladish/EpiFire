...
#mkdir epifire.app/Contents/Frameworks
#cp -R /Library/Frameworks/QtCore.framework ./epifire.app/Contents/Frameworks
#cp -R /Library/Frameworks/QtGui.framework ./epifire.app/Contents/Frameworks
#/usr/bin/qmake /Users/tjhladish/EpiFire/gui/epifire.pro -spec macx-g++ -macx -r CONFIG+=release -o Makefile
#make -j2
install_name_tool -id @executable_path/../Frameworks/QtCore.framework/Versions/4/QtCore epifire.app/Contents/Frameworks/QtCore
install_name_tool -id @executable_path/../Frameworks/QtGui.framework/Versions/4/QtGui epifire.app/Contents/Frameworks/QtGui
